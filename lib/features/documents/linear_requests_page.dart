    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'إعداد ملف النموذج وفيه رموز مثل {{الاسم_واللقب}} ← إضافة النموذج من الهاتف ← إعداد استمارة المعلومات بنفس الحقول ← حفظ النموذج ← ملء الاستمارة لاحقًا ← استبدال الرموز وتوليد PDF وأرشفته.',
            style: TextStyle(
              color: AppColors.muted,
              height: 1.6,
            ),
